...
### 内链卡片预览
自动读取本站文章的标题、摘要和头图。构建速度极快。
```markdown
[点击查看：MD3 博客主题发布！]({% post_url Announcements/2026-08-13-transition-announcement %}){: .preview }

[点击查看：指定的内链文章]({% post_url ZGQincLiqun/2022-07-19-a8c9n3 %}){: .preview }
```
**效果：**
[点击查看：MD3 博客主题发布！]({% post_url Announcements/2026-08-13-transition-announcement %}){: .preview }
