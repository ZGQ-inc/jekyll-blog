...
```markdown
<!-- 1. 全年龄普通画作（无裁切自适应立绘） -->
[Pixiv 画作：Rangiku Matsumoto (112217641)](https://www.pixiv.net/artworks/112217641){: .preview }

<!-- 2. e621 角色/原作/物种结构化元数据与多画师卡片 -->
[e621 插画：Deeja (3720760)](https://e621.net/posts/3720760){: .preview }

<!-- 3. Pixiv R-18 敏感内容自动毛玻璃遮罩 -->
[Pixiv R-18 画作：ギンガ団したっぱちゃん (95543160)](https://www.pixiv.net/artworks/95543160){: .preview }

<!-- 4. e621 Explicit (R-18) 自动毛玻璃遮罩 -->
[e621 R-18 插画：Reina (6714373)](https://e621.net/posts/6714373){: .preview }
```
...
```markdown
{% raw %}{% include youtube.html url="https://www.youtube.com/watch?v=dQw4w9WgXcQ" %}{% endraw %}
```
**效果：**
{% include youtube.html url="https://www.youtube.com/watch?v=dQw4w9WgXcQ" title="Rick Astley - Never Gonna Give You Up" %}

#### 2. Spotify 音乐播放器
支持单曲 (Track)、专辑 (Album)、歌单 (Playlist) 与播客 (Episode)，支持正常模式与紧凑 (Compact) 模式：
```markdown
{% raw %}{% include spotify.html url="https://open.spotify.com/track/4cOdK2wGLETKBW3PvgPWqT" compact=true %}{% endraw %}
```
**效果：**
{% include spotify.html url="https://open.spotify.com/track/4cOdK2wGLETKBW3PvgPWqT" compact=true %}

#### 3. Telegram 消息与动态嵌入
拥有专用 postMessage 动态高度监听机制，**实时同步并撑开容器高度**，彻底消除内嵌滚动条或上下内容被裁切遮挡的痛点：
```markdown
{% raw %}{% include telegram.html url="https://t.me/zgqinc/164" %}{% endraw %}
```
**效果：**
{% include telegram.html url="https://t.me/zgqinc/164" %}

#### 4. Twitter / X 动态推文
遵循官方 X Publish 标准，自动适配夜间与浅色模式并融入 MD3 居中边距：
```markdown
{% raw %}{% include twitter.html url="https://twitter.com/x/status/1715425625442541818" %}{% endraw %}
```
**效果：**
{% include twitter.html url="https://twitter.com/x/status/1715425625442541818" %}

#### 5. Reddit 社区讨论嵌入
原生支持 Reddit 官方交互组件：
```markdown
{% raw %}{% include reddit.html url="https://www.reddit.com/r/technology/comments/1f4x9v2/test/" %}{% endraw %}
```
**效果：**
{% include reddit.html url="https://www.reddit.com/r/technology/comments/1f4x9v2/test/" %}
...
### 语法示例
```markdown
![Villager News 剧透防护演示](/assets/images/2026-09/villager_news_addon.jpg){: .blur data-reason="剧透警告：村民新闻 Add-On 官方高清海报" }
```
