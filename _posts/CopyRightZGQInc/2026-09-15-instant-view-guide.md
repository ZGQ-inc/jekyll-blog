...
### 12. 数学公式与 LaTeX 排版 (Math Formulas)

Telegram IV 虽不执行 MathJax 动态脚本，但对规范的 LaTeX 文本结构友好支持：

* 行内公式演示：根据相对论质能等价理论，能量等于质量乘以光速的平方，即 $E = mc^2$。
* 块级高斯积分公式演示：

\[\int_{-\infty}^{\infty} e^{-x^2} dx = \sqrt{\pi}\]

公式文本在即时预览中保持清晰、居中且对比度优秀的排版呈现。
